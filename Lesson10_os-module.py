...
os.chdir('/Users/wesley.heesters/Desktop/')  # Changes current working dir
...
print(datetime.fromtimestamp(timestamp).strftime("%Y-%m-%d %H:%M:%S"))  # Converts a given timestamp to human readable form .strftime is for formatting
